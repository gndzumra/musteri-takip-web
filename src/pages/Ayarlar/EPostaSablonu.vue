    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12">
          ...
          >
            <h4 class="mb-sm-0 font-size-18">E-Posta Gönderim Şablonu</h4>
            ...
            <div class="page-title-right">
              <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item active">E-Posta Şablonu</li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">E-Posta Gönderim Şablonu</h4>
